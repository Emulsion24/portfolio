...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#090a0b] text-[#f4f4ef]">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1fr_.46fr]">
            ...
            <div className="relative hidden h-[520px] lg:block">
              ...
              >
                ...
                <p className="text-[8px] uppercase tracking-[.2em] text-white/20">
                  Featured
                </p>
              ...
              >
                ...
                <p className="mt-1 text-xs text-[#d9ff4f]">
                  Building AI
                </p>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 overflow-hidden rounded-[26px] border border-white/10 md:grid-cols-4">
          ...
          {[
            ...
            >
              ...
              <p className="text-3xl font-medium tracking-[-.05em] md:text-5xl">
                {number}
              </p>

              <p className="mt-2 text-[8px] uppercase tracking-[.18em] text-white/20">
                {label}
              </p>
          ...
          <div className="grid gap-12 lg:grid-cols-[.45fr_.55fr]">
            ...
            <div className="flex items-end">
              ...
              <p className="max-w-md text-sm leading-7 text-white/35">
                ...
                data-heavy products, utilities and premium landing
                experiences.
              </p>
                ...
                (project, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-2 max-w-2xl text-sm text-white/30">
                        {project.description}
                      </p>
          ...
          <div className="grid gap-16 lg:grid-cols-[.3fr_.7fr]">
            ...
            <div>
              ...
              <h2 className="text-4xl font-medium leading-[.95] tracking-[-.055em] md:text-6xl">
                ...
                <span className="text-white/20">
                  {" "}
                  where business problems meet technology.
                </span>
      ...
      <section className="px-5 pb-28 md:px-10 md:pb-40">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-12">
            ...
            <h2 className="mt-6 text-5xl font-medium tracking-[-.06em] md:text-7xl">
              From problem
              <br />
              to product.
            </h2>
          ...
          <div className="grid gap-3 md:grid-cols-4">
            ...
            {[
              ...
              <motion.div
                ...
                className="rounded-2xl border border-white/10 bg-[#111315] p-6"
              >

                <p className="text-[9px] font-bold text-[#d9ff4f]">
                  0{index + 1}
                </p>
        ...
        <footer className="mx-auto mt-10 flex max-w-7xl flex-col justify-between gap-7 border-t border-white/10 py-8 md:flex-row md:items-center">
          ...
          <div className="flex gap-2">
            ...
            <a
              href="#"
              aria-label="GitHub"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/35 transition hover:border-[#d9ff4f]/30 hover:text-[#d9ff4f]"
            >
              <FaGithub size={13} />
            </a>
          ...
          <p className="text-[9px] text-white/20">
            © {new Date().getFullYear()} Shavandeb Kaiti
          </p>
